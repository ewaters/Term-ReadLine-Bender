...
BEGIN {
	require Test::More;
	use Term::ReadLine::Bender::ViCommand;
	Test::More->import( tests => 18 + scalar @Term::ReadLine::Bender::ViCommand::vi_motions - 6 );
}

my $t;
$t = Term::ReadLine::Bender->new('test');
...
for my $k (@Term::ReadLine::Bender::ViCommand::vi_motions, 'd') {
	test_reset $t;
