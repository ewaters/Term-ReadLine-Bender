package Term::ReadLine::Bender::Emacs;
...
Term::ReadLine::Bender::Emacs - a readline emacs mode
...
These bindings are additional to those in L<Term::ReadLine::Bender> which
