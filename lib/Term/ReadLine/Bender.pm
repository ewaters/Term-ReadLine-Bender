package Term::ReadLine::Bender;

use strict;
use vars '$AUTOLOAD';
use Term::ReadLine::Bender::Base;
#use encoding 'utf8';
no warnings; # undef == '' down here

our @ISA = qw/Term::ReadLine::Bender::Base Term::ReadLine::Stub/; # explicitly not use'ing T:RL::Stub
our $VERSION = '0.07';
...
sub import { # terrible hack - Term::ReadLine in perl 5.6.x is defective
	...
	*Term::ReadLine::Stub::new = sub {
		shift;
		my $self = bless {}, 'Term::ReadLine::Bender';
		return $self->_init(@_);
	};
}
...
our %_keymaps = (
	...
	command => { _use => 'Term::ReadLine::Bender::ViCommand'  },
	emacs   => { _use => 'Term::ReadLine::Bender::Emacs'      },
	emacs_multiline => { _use => 'Term::ReadLine::Bender::Emacs' },
	fbrowse => { _use => 'Term::ReadLine::Bender::FileBrowse' },
	isearch => { _use => 'Term::ReadLine::Bender::ISearch'    },
);
...
sub ReadLine { return 'Term::ReadLine::Bender' }
...
sub current {
	...
	my (undef, $f, $l) = caller;
	die "No current Term::ReadLine::Bender object at $f line $l";
}
...
Term::ReadLine::Bender - another ReadLine package
...
Place the line editor in command mode, see L<Term::ReadLine::Bender::ViCommand>.
...
see L<Term::ReadLine::Bender::MultiLine>.
...
Enter incremental search mode, see L<Term::ReadLine::Bender::ISearch>.
...
L</autolist> feature you can set C<PERL_RL='Bender autolist=0'> before
you start the application.

( Also they can be altered interactively using the mini-buffer of 
the command mode, see L<Term::ReadLine::Bender::ViCommand>. )
...
The rc-file is a perl script with access to the Term::ReadLine::Bender object through
...
try to check for C<< $rl->{appname} >>.
	...
	my $rl = Term::ReadLine::Bender->current();
...
Returns the current T:RL::Bender object, for use in rc files, see L</FILES>.
...
L<Term::ReadLine::Bender::ViCommand>,
L<Term::ReadLine::Bender::MultiLine>,
L<Term::ReadLine::Bender::ISearch>,
L<Term::ReadLine::Bender::FileBrowse>,
L<Term::ReadLine::Bender::Base>,
L<Term::ReadLine>,
L<Env::PS1>,
L<Zoidberg>
